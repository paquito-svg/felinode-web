...
export const metadata: Metadata = {
    title: "Eliminación de Cuenta - nekoEnglish",
    description: "Pasos detallados para eliminar tu cuenta y datos asociados en nekoEnglish.",
};
    ...
    return (
        <div className="container legal-page">
            ...
            <div className="legal-content">
                <p>
                    En nekoEnglish, valoramos tu privacidad. Si deseas eliminar tu cuenta y todos los datos asociados, puedes hacerlo directamente desde la aplicación o solicitándolo por correo electrónico.
                </p>
                ...
                <ol style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem', color: '#a1a1aa', lineHeight: '1.7' }}>
                    <li style={{ marginBottom: '0.5rem' }}>Abre la aplicación <strong>nekoEnglish</strong> en tu dispositivo.</li>
                ...
                <br />
                <p><em>Nota: Si utilizaste nekoEnglish únicamente en el modo "Invitado", tus datos sólo se guardaron localmente en tu dispositivo; en ese caso, basta con borrar los datos o desinstalar la aplicación para eliminarlos.</em></p>
            </div>
        </div>
    );
}
